  ...
  it 'returns reasonable data by default' do
    ...
    expected_data = { 'contributions' =>
                          [{
                               ...
                               'person' => { 'id' => contribution.person.id, 'name' => contribution.person.name, 'email' => contribution.person.email, 'phone' => contribution.person.phone, 'skills' =>  contribution.person.skills, 'preferred_contact_method' => contribution.person.preferred_contact_method.first},
                               'location' => nil,
