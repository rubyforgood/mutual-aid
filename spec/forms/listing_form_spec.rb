...
RSpec.describe ListingForm do
  ...
  #
  #
  #   it 'includes both default and custom categories' do
  #     expect(all_tags.size).to eq(default_tags.size + 1)
  #   end
  #
  #   it 'appends custom categories to the bottom' do
  #     expect(all_tags.last).to eq('a custom tag')
  #   end
  #
  #   it 'does not duplicate categories from the default list' do
