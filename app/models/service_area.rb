class ServiceArea < ApplicationRecord
  ...
  has_many :asks, class_name: "Listing::Ask", foreign_key: "service_area_id", inverse_of: :service_area
  has_many :offers, class_name: "Listing::Offer", foreign_key: "service_area_id", inverse_of: :service_area
  has_many :listings
  has_many :people
