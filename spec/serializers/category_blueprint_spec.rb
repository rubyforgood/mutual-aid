...
RSpec.describe CategoryBlueprint do
  describe 'render' do
    it 'can serialize a class that provides `.as_filter_categories`, `#name`, and `#id`' do
      ...
      expect(class_double).to receive(:as_filter_categories).and_return(service_areas)
      ...
      actual_data = CategoryBlueprint.render(class_double)
