<template>
  <div class="ask-form">
    <h1 class="title">Ask for support</h1>

    <div class="columns">
      <form action="/asks" method="post" class="column is-half-tablet">
        <AuthTokenInput />
...
import CategoryFields from './ask/CategoryFields'
import ContactFields from './ask/ContactFields'
import LocationFields from './ask/LocationFields'
import ServiceAreaField from './ask/ServiceAreaField'
...
export default {
  ...
  data() {
    const person = this.ask.person || {}
    return {
      person,
      preferredContactMethodId: person.preferred_contact_method_id,
      tagList: this.ask.all_tags_list,
      errors: this.ask.errors,
    }
  },
  computed: {
    hasErrors() {
