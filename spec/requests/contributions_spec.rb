...
RSpec.describe '/contributions', type: :request do
  ...
  describe 'GET /index' do
    ...
    it 'parses requests for a filtered list' do
      ...
      expected_area.save!
      one_tag_listing = create(:listing, service_area: expected_area,
                                         tag_list: categories.sample.name)
      ...
      # passing `as: json` to `get` does some surprising things to the request and its params
