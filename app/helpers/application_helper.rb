module ApplicationHelper
  ...
  def edit_button(resource, button_text="Edit", icon_class="fa fa-edit", button_text_class=nil)
    if resource
  ...
  def show_button(resource, button_text="View", icon_class="fa fa-eye", margin_class=nil, button_text_class=nil)
    resource_class = resource.class
