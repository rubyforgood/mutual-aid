class ExternalResourcesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @external_resource.save
        format.html { redirect_to @admin_status ? external_resources_path : community_resources_public_path, notice: "External resource was successfully submitted.#{ " We'll review." unless @admin_status }" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to community_resources_public_path, notice: 'External resource was successfully destroyed.' }
