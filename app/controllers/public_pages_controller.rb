class PublicPagesController < PublicController
  ...
  def about
    @about_us_text = HtmlSanitizer.new(@system_setting.about_us_text).sanitize_for_rails.html_safe
  end
  ...
  def landing_page
    @landing_page_text_what = HtmlSanitizer.new(@system_setting.landing_page_text_what).sanitize_for_vue.html_safe
    @landing_page_text_who = HtmlSanitizer.new(@system_setting.landing_page_text_who).sanitize_for_vue.html_safe
    @landing_page_text_how = HtmlSanitizer.new(@system_setting.landing_page_text_how).sanitize_for_vue.html_safe
